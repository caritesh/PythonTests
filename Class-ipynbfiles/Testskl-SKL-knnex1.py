...
df = pd.read_csv("https://raw.githubusercontent.com/ajaykuma/Datasets_For_Work/main/breast-cancer-wisconsin.csv")
...
predictnow = clf.predict(X_test)
predictnow
y_test

#another example
my_test = np.array([5,1,1,1,3,1,3,1,1])
my_test = my_test.reshape(1,-1)
predictnow = clf.predict(my_test)
#check values of predictnow
